...
def show_IRF():
    ...
    st.write(""" 
        ...
        Aplikasi berbasis web untuk mengklasifikasi type Malicious URL (Improved Random Forest)
        """)
    ...
    if (url == ""):
        ...
        malware_raw = pd.read_csv('features_ros2.csv')
        ...
        load_model = pickle.load(open('modelIRF.pkl', 'rb'))
